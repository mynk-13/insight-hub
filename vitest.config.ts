  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        // Billing modules requiring real Stripe/Razorpay/PayPal/DB/Redis — covered by E2E
        "src/lib/modules/billing/adapters/stripe.ts",
        "src/lib/modules/billing/adapters/razorpay.ts",
        "src/lib/modules/billing/adapters/paypal.ts",
        "src/lib/modules/billing/adapters/billdesk.ts",
        "src/lib/modules/billing/router.ts",
